      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
          ...
          <motion.div
            ...
            className="flex items-center justify-center pt-8 lg:sticky lg:top-0 lg:h-screen"
          >
                  ...
                  <motion.div
                    ...
                    animate={
                      itemInView
                        ...
                        : { opacity: 0.3, x: index % 2 === 0 ? -30 : 30 }
                    }
                    className={`relative p-6 flex min-h-[25vh] items-center ${
