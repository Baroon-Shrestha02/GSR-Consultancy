...
const ContactCard = ({ info }) => {
  return (
    <motion.div
      ...
      className="bg-white/30 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/20 hover:shadow-xl transition-shadow duration-300 group text-gray-900"
      whileHover={{
        scale: 1.02,
...
export default function HomeWhy2() {
  ...
  return (
    <section className="py-20" style={{ backgroundColor: "#fff8f0" }} ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-700 text-lg max-w-2xl mx-auto">
            Get in touch with us today. We're here to help you with all your needs and answer any questions you may have.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white/30 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/20 mt-8"
            >
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 shadow-lg"
                  whileHover={{
                    scale: 1.02,
                    boxShadow: "0 10px 30px rgba(253, 230, 138, 0.3)",
                  }}
                  whileTap={{ scale: 0.98 }}
                >
                  Send Message
          ...
          >
            <div className="bg-white/30 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/20">
              <h3 className="text-2xl font-bold mb-6">Find Us Here</h3>
              ...
              {/* Location Details */}
              <div className="mt-6 p-4 bg-white/20 backdrop-blur-md rounded-lg">
                <h4 className="font-semibold mb-2">Our Location</h4>
                <p className="text-gray-700 text-sm mb-2">123 Business Street, Suite 100</p>
                <p className="text-gray-700 text-sm mb-3">BagBazar, Putalisadak</p>
              </div>
            </div>
          </motion.div>
        </div>
