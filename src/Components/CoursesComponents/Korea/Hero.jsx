...
export default function Hero() {
  ...
  const sendWhatsApp = (e) => {
    ...
    const whatsappMessage = `Hello Omni Global,%0A%0AI am interested in studying in Korea. Here are my details:%0A%0AName: ${name}%0AEmail: ${email}%0APhone: ${phone}%0APreferred Study: ${preferredStudy}%0AMessage: ${message}%0A%0APlease get in touch with me.`;
  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: "url('/Studyinkorea.jpeg')" }}
      >
